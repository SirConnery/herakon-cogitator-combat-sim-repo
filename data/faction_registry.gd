...
static func get_database() -> Dictionary:
	...
	db[FactionID.SM] = {
		"name": "Space Marines",
		"debug_deck": [1003,1003,1003,1003,1003], # used instead of combat_deck when game_stage_generator.use_debug_deck_for_testing == true
	...
	db[FactionID.ORKS] = {
		"name": "Orks",
		"debug_deck": [2005,2005,2005,2005,2005,],
