...
DRAW_COMBAT_CARDS,
DISCARD_RANDOM_CARD_FROM_HAND,
DISCARD_WORST_FACEUP_CARD,
DISCARD_BEST_FACEUP_CARD,
DISCARD_STEAL_ICONS,
...
ALL_UNITS_GAIN_DAMAGE_IMMUNITY_THIS_ROUND,
}
...
enum ConditionType {
	...
	IS_FIRST_COMBAT_ROUND,
	IS_NOT_FIRST_COMBAT_ROUND,
	ALL_UNITS_HAVE_DAMAGE_IMMUNITY,
