...
DISCARD_STEAL_ICONS,
PLAY_RANDOM_CARD_DO_NOT_RESOLVE_ABILITIES,
...
DESTROY_LOWEST_TIER,
DESTROY_HIGHEST_TIER_ROUTED_UNIT,
...
# CSM
CHAOS_UNITED_UNIT_ABILITY, # Chaos United
DEATH_AND_DESPAIR_GENERAL_ABILITY_2, # Death and Despair
ROUT_ALL_COMMAND_LEVEL_0_UNITS, # Chaos Victorious
...
# ELDAR
PREVENT_OPPONENT_GAINING_DEFENSE_TOKENS_THIS_ROUND,
}
...
enum ConditionType {
	...
	HAS_MORE_MORALE_THAN_OPPONENT_AND_OPPONENT_HAS_ROUTED_UNITS,
	
	# Eldar
	HAS_MORALE_DICE_AND_OPPONENT_HAS_UNROUTED_UNITS,
	OPPONENT_HAS_MORALE_DICE_AND_OPPONENT_HAS_UNROUTED_UNITS,
	OPPONENT_HAS_NO_MORALE_DICE_AND_OPPONENT_HAS_UNROUTED_UNITS,
